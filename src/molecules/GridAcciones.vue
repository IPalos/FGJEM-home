			...
			<b-card title="Atención Ciudadana" img-height="38px" img-width="30px" :img-src="require('@/assets/atencion.png')"
				...
				<b-card-text>
					<ul>
						...
						<li>Módulos de Denuncia Express</li>
						<li>Denuncia contra servidores públicos</li>
			...
			<b-card title="Tramites en línea" img-height="38px" img-width="30px" :img-src="require('@/assets/tramites.png')"
				...
				<b-card-text>
					<ul>
						...
						<li>Vehículos</li>
						<li>Reporte de robo</li>
						<li>Listado de vehículos recuperados</li>
						<li>Constancia de extravío de objetos o documentos</li>
					</ul>
				</b-card-text>
				<p slot="footer">Ver mas ></p>
			</b-card>
			...
			<b-card title="Alerta de Género" img-height="38px" img-width="30px" :img-src="require('@/assets/genero.png')"
				...
				<b-card-text>
					<ul>
						...
						<li>Odisea y Alerta Amber</li>
						<li>Estadísticas de feminicidio y homicidio doloso</li>
						<li>Prensa</li>
					</ul>
				</b-card-text>
				<p slot="footer">Ver mas ></p>
			...
			<b-card title="Acciones FGJEM" img-height="38px" img-width="30px" :img-src="require('@/assets/acciones.png')"
				...
				<b-card-text>
					<ul>
						...
						<li>Jornada de la criminalística</li>
					</ul>
				</b-card-text>
				<p slot="footer">Ver mas ></p>
			</b-card>
